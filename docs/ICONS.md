...
**Notes:**
- Official X logo (post-rebrand)
- Monochrome design works well at small sizes
...
- Complex path - may need simplification for QR overlay
...
**Notes:**
- Official TikTok logo (note without brand colors)
...
**Notes:**
- PayPal P logo (simplified)
- **ISSUE:** Only shows the P, may not be immediately recognizable
...
**Notes:**
- Amazon shopping bag with smile
- **ISSUE:** May not be immediately recognizable as Amazon
- Consider using the "a" logo or shopping cart instead
...
**Notes:**
- Official Reddit snoo mascot
- Complex path, recognizable
...
**Notes:**
- Official Telegram logo (paper airplane)
- Clean, recognizable
...
For official brand icons, refer to:
- [Simple Icons](https://simpleicons.org/) - SVG icons for popular brands
- [Brandfetch](https://brandfetch.com/) - Official brand assets
...
1. Find the icon definition in `src/utils/icons.tsx`
2. Replace the SVG path data in the component
3. Test at multiple sizes (16px, 24px, 32px)
4. Ensure icon works in both light and dark modes
5. Verify icon is recognizable when small (for QR overlay)

```tsx
// Example icon component
const NewIcon = ({ className, size }: { className?: string; size?: number }) => (
  <svg 
    width={size || 24} 
    height={size || 24} 
    viewBox="0 0 24 24" 
